...
func TestNoSyncBroadcaster_CloseAll(t *testing.T) {
	broadcast := NewNoSyncBroadcaster[int](10)
...
func TestNoSyncBroadcaster_SubUnsub(t *testing.T) {
	broadcast := NewNoSyncBroadcaster[int](10)
	var wg sync.WaitGroup
	n, m := 100, 10
	wg.Add(m)
...
func TestNoSyncBroadcaster_SendOrWait(t *testing.T) {
	broadcast := NewNoSyncBroadcaster[int](1)
	sub := broadcast.Subscribe()
...
func TestNoSyncBroadcaster_SendOrSkip(t *testing.T) {
	broadcast := NewNoSyncBroadcaster[int](1)
	sub := broadcast.Subscribe()
...
func TestNoSyncBroadcaster_SendOrUnsubscribe(t *testing.T) {
	broadcast := NewNoSyncBroadcaster[int](1)
	sub := broadcast.Subscribe()
